...
public class OAuth2JwtBearerCrudTest extends AbstractAuthOnCrudTest {

    private static final String TOKEN_ENDPOINT = "/oauth2/token";
    private static final String ACCESS_TOKEN = "oauth2-jwt-crud-token";
