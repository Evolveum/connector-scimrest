...
public class GroovyOAuth2JwtBearerCrudTest extends AbstractGroovyAuthCrudTest {

    private static final String TOKEN_ENDPOINT = "/oauth2/token";
    private static final String ACCESS_TOKEN = "groovy-jwt-crud-token";
    ...
    private static class Config extends BaseTestConfiguration
        ...
        Config(int port, String tokenUrl, String clientId, GuardedString privateKey) {
            super(port);
        ...
        @Override public String getRestOAuth2Issuer() { return null; }
        @Override public String getRestOAuth2KeyId() { return null; }
        @Override public String getRestOAuth2Algorithm() { return "RS256"; }
        @Override public String getRestOAuth2Subject() { return null; }
