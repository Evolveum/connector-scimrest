...
See xref:../declarative-yaml.adoc[declarative YAML] for the full schema YAML reference.
...
See xref:relationship-support.adoc[relationship support] for a complete example.
