...
Besides building connectors from scratch (see xref:rest/index.adoc[REST guide] and xref:scim/index.adoc[SCIM 2.0 guide]), the repository ships generic, low-code connectors you can use as-is or as a starting point.
